...
<head>
<meta charset="UTF-8">
<title>Appointment Status Management</title>
...
<main>
  ...
  <div class="page-title">Appointment Status Management</div>
  ...
  <div class="top-controls">
    ...
    <a href="add_status.php">
      <button class="btn-add">+ Add Status</button>
    </a>
  </div>
  ...
  <div class="table-container">
    <table>
      ...
      <tr>
        <td colspan="3" style="text-align:center;">No status data...</td>
      </tr>
    </table>
  </div>
