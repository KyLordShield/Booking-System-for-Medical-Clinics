...
<body class="bg-[var(--secondary)] min-h-screen flex flex-col font-[Georgia]">
  ...
  <div class="navbar flex justify-between items-center px-10 py-5 bg-[var(--primary)] rounded-b-[35px] shadow-lg">
    ...
    <div class="nav-links flex gap-4">
      ...
      <a class="active" href="/Booking-System-For-Medical-Clinics/public/staff_pages/specialization.php">Specialization</a>
      ...
      <table class="w-full border-collapse text-[var(--primary)]">
        <thead>
          <tr class="border-b border-gray-300">
            <th class="py-3 px-4 text-left">Specialization ID</th>
            <th class="py-3 px-4 text-left">Specialization Name</th>
        ...
        <tbody>
          ...
          <tr class="border-b border-gray-300 hover:bg-gray-50">
            <td colspan="3" class="py-6 text-center text-gray-500">No specialization found...</td>
          </tr>
        </tbody>
      </table>
    </div>
